      ...
      <ul className="">
        <Link href="/" title="ImgNext Home">
          <li className="font-semibold p-1 text-xl">
            Img<span className="text-orange-500 ml-1">Next</span>
          </li>
        </Link>
      </ul>
      <ul className=" flex gap-8 items-center">
      <Link href="/rundna">
          <li className="text-lg px-2 py-2 rounded-md hover:bg-slate-200 duration-200 hover:shadow-md">
            Run<span className="font-bold text-orange-500">DNA</span>
          </li>
        </Link>
