import CleanColorName from "./CleanColorName";

export default function Note() {
  return (
    <>
      <div className="w-full mt-4 bg-white px-4 py-2 rounded-md overflow-hidden flex gap-4 justify-between items-center">
        <div className="px-2">
